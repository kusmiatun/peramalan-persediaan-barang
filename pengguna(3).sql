...
INSERT INTO `data_obat` (`id_obat`, `deskripsi_obat`, `merk`) VALUES
(1, 'kaditic 50mg', 'ifars');
...
(116, 'Amoxicillin 500 MG HJ Isi 200', '2024-06-25', 89);
...
(150, 'marketing', 'marketing', 3455, 'role', '2024-06-11 08:42:15'),
(153, 'keuangan', 'keuangan', 8900, 'role', '2024-06-11 08:43:08'),
(155, 'gudang', 'gudanfg', 1456, 'role', '2024-06-11 09:12:30'),
(164, '', '', 0, 'pengadaan', '2024-06-11 10:16:39');
...
--
ALTER TABLE `data_penjualan`
  MODIFY `id_penjualan` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;

--
-- AUTO_INCREMENT untuk tabel `skun_pengguna`
--
ALTER TABLE `skun_pengguna`
  MODIFY `id_pengguna` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;
COMMIT;
